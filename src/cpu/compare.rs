...
pub fn comp_value_absolute_reg(
    pc_reg: &mut u16,
    acc: u8,
    abs_addr: u16,
    reg: u8,
...
pub fn comp_value_indexed_indirect(
    pc_reg: &mut u16,
    acc: u8,
    addr: u8,
    x_reg: u8,
...
pub fn comp_value_indirect_indexed(
    pc_reg: &mut u16,
    acc: u8,
    addr: u8,
    y_reg: u8,
