...
pub fn incdec_memory_zero_page(
    pc_reg: &mut u16,
    operand: u8,
    status_flags: &mut u8,
    memory: &mut RAM,
...
pub fn incdec_memory_zero_page_x(
    pc_reg: &mut u16,
    operand: u8,
    x_val: u8,
    status_flags: &mut u8,
...
pub fn incdec_memory_absolute_x(
    pc_reg: &mut u16,
    operand: u16,
    x_val: u8,
    status_flags: &mut u8,
