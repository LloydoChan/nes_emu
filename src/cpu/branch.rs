...
fn branch_on_flag_set(flag_val : u8, pc_reg : &mut u16, relative_addr : i8, flag_bit: u8, cycles : &mut u8){
...
fn branch_on_flag_not_set(flag_val : u8, pc_reg : &mut u16, relative_addr : i8, flag_bit: u8, cycles : &mut u8){
...
pub fn branch_if_carry_set(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_set(flag_val, &mut pc_reg, relative_addr, flags::CARRY_BIT, cycles);
}

pub fn branch_if_carry_clear(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_not_set(flag_val, &mut pc_reg, relative_addr, flags::CARRY_BIT, cycles);
}

pub fn branch_if_equal(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_set(flag_val, &mut pc_reg, relative_addr, flags::ZERO_BIT, cycles);
}

pub fn branch_if_not_equal(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_not_set(flag_val, &mut pc_reg, relative_addr, flags::ZERO_BIT, cycles);
}

pub fn branch_if_minus(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_set(flag_val, &mut pc_reg, relative_addr, flags::NEGATIVE_BIT, cycles);
}

pub fn branch_if_positive(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_not_set(flag_val, &mut pc_reg, relative_addr, flags::NEGATIVE_BIT, cycles);
}

pub fn branch_if_overflow_set(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_set(flag_val, &mut pc_reg, relative_addr, flags::OVERFLOW_BIT, cycles);
}

pub fn branch_if_overflow_clear(flag_val : u8, mut pc_reg : &mut u16, relative_addr : i8, cycles : &mut u8){
    branch_on_flag_not_set(flag_val, &mut pc_reg, relative_addr, flags::OVERFLOW_BIT, cycles);
}
